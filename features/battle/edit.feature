...
Background:
    ...
    And current time is 2015-05-26 12:28:00 -0300

    @javascript
    Scenario: User cannot see battle form unless he press the button to edit battle
      When I go to the home page
      Then I should not see the edit battle form for 1st battle

    @javascript
    Scenario: User can edit a battle from home page
      When I go to the home page
